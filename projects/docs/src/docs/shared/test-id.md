...
You can customize how test IDs are generated by providing a `testIdBuilderFn`. This function receives the control's content, its name, and its parent's test ID (if any) and should return the desired test ID string.
