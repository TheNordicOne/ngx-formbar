...
Running the following command will install _ngx-formwork_.
...
- Add _ngx-formwork_ as a dependency
...
| --registrationStyle       | `token` \| `map` | No       | `token`                   | The registration style to be used.                                                                                                                                                                                        |
