...
In addition to setting up the `app.config.ts`, you must also add a configuration to let formwork know, that you are using the config registration style.

Add this file next to your `app.config.ts`
```ts title="formwork.config.json"
{
