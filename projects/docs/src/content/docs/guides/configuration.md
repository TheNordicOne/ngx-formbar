...
Once you've registered [Controls](/guides/controls), [Groups](/guides/groups) and optionally validators, you can write a configuration for a form, either directly in JSON or in TypeScript, for better typing information.
