...
describe('Form Visibility Strategies', () => {
   ...
   */
  const setupForm = (formContent: NgxFwContent[]): void => {
    cy.mount(FormIntegrationHostComponent, {
      providers: [formworkProviders],
      componentProperties: {
        formContent,
   ...
   */
  const fillInput = (testId: string, value: string): void => {
   ...
   */
  const verifyFieldValue = (fieldId: string, expectedValue: string): void => {
   ...
   */
  const verifyFieldNotExist = (fieldId: string): void => {
