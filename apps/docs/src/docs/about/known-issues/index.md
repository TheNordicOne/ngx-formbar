Known issues are listed below, with links to GitHub issues where they exist.
This list is not exhaustive. Also check the [GitHub Issues](https://github.com/TheNordicOne/ngx-formbar/issues) for anything not listed here.
