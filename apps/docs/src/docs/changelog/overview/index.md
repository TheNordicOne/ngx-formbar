...
|-------------------------------|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `@ngx-formbar/core`           | Yes              | Removed reactive forms dependency. Component registrations now use `ComponentRegistrationEntry` (static or lazy). Helper functions `component()` and `loadComponent()` added. Directives, form component, validators, and provider setup moved to `@ngx-formbar/reactive-forms`. |
