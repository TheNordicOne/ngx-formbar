ngx-formbar does not mark a control as `readonly`, since Angular's form API has no built-in concept for this. Provide an expression and use the resolved value in your template.
