**formbar** does not mark a control as `readonly`, since reactive forms has no API for this. Provide an expression and use the resolved value in your template.
