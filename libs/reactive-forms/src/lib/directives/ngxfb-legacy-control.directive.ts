...
import { NgxfbLegacyGroupDirective } from './ngxfb-legacy-group.directive';
 ...
 *   private readonly control = inject(NgxfbLegacyControlDirective<TextControl>);
 ...
 */
@Directive({
  selector: '[ngxfbLegacyControl]',
  host: {
    '[attr.hidden]': 'hiddenAttribute()',
  },
})
export class NgxfbLegacyControlDirective<T extends NgxFbControl>
  implements OnDestroy
{
  ...
  private readonly parentGroupDirective: NgxfbLegacyGroupDirective<NgxFbFormGroup> | null =
