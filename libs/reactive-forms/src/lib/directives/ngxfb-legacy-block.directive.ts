 ...
 *   hostDirectives: [
 *     {
 *       directive: NgxfbLegacyBlockDirective,
 *       inputs: ['content', 'name'],
 *     }
 *   ],
 * })
 * export class InfoBlockComponent {
 *   private readonly blockDirective = inject(NgxfbLegacyBlockDirective<InfoBlock>);
 ...
 */
@Directive({
  selector: '[ngxfbLegacyBlock]',
  host: {
    '[attr.hidden]': 'hiddenAttribute()',
  },
})
export class NgxfbLegacyBlockDirective<T extends NgxFbBaseContent> {
  /**
