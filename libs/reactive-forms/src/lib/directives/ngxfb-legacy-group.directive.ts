 ...
 *   private readonly control = inject(NgxfbLegacyGroupDirective<Group>);
 ...
 */
@Directive({
  selector: '[ngxfbLegacyGroup]',
  host: {
    '[attr.hidden]': 'hiddenAttribute()',
  },
})
export class NgxfbLegacyGroupDirective<T extends NgxFbFormGroup>
